import 'package:commerce/data/models/home_screen_slider_model.dart';
...
class HomeScreenSliderController extends GetxController {
  ...
  Future<bool> getHomeScreenSlider() async {
    ...
    final NetworkResponse response =
        await NetworkCaller.getRequest(Urls.homeScreenSlider);
    _homeScreenSliderInProgress = false;
    if (response.isSuccess && response.statusCode == 200) {
      _sliderModel =
          HomeScreenSliderModel.fromJson(response.responseJson ?? {});
      update();
      return true;
    } else {
